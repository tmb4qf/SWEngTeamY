...
<!--                <tr>
    ...
    <div class="row-fluid">
      <div class="col-md-12">
        <input class="btn btn-primary btn-lg" type="submit" value="Deny Request" id="submit" onclick="submitForm()"/>   
                <?php echo form_close(); ?>
        <?php $attributes = array('class' => 'form-horizontal'); 
            echo form_open('ViewRequestController/acceptRequest', $attributes);
        ?>
        <input type="hidden" id="id" value="<?php print $applicantID; ?>" name="id">
        <input type="submit" value="Accept Request" class="btn btn-primary btn-lg">
        <?php echo form_close(); ?>
      </div>
    </div>
  </div>
